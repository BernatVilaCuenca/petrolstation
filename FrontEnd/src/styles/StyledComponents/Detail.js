...
const data = {
    inputs: {
        XS: Styled.input`width: 47px; margin-right: 5px`,
        S: Styled.input`width: 90px; margin-right: 5px`,
        M: Styled.input`width: 115px; margin-right: 5px`,
        L: Styled.input`width: 210px; margin-right: 5px`,
    ...
    labels: {
        XS: Styled.label`width: 47px; margin-right: 5px`,
        S: Styled.label`width: 90px; margin-right: 5px`,
        M: Styled.label`width: 115px; margin-right: 5px`,
        L: Styled.label`width: 210px; margin-right: 5px`,
        XL: Styled.label`width: 330px; margin-right: 5px`,
        required: Styled.label`{ color: red; font-weight: bold}`
    },
    selects: {
        XS: Styled.select`width: 47px; margin-right: 5px`,
        S: Styled.select`width: 90px; margin-right: 5px`,
        M: Styled.select`width: 115px; margin-right: 5px`,
        L: Styled.select`width: 210px; margin-right: 5px`,
